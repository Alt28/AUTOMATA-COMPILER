...
TT_STRINGLIT = 'strlit'         # String literal token (e.g., "hello")
TT_CHARLIT = 'chlit'           # Character literal token (e.g., 'a')
        ...
        while self.current_char != None:
            ...
            # =====================================================================
                ...
                if dot_count == 0 and integer_digit_count > 8:
                    i = 0
                    while i < len(ident_str):
                        # Check if there are at least 9 digits remaining
                ...
                if dot_count == 0 and not has_e:
                    ...
                    if self.current_char is not None and self.current_char not in whlnum_delim:
                        ...
                        if self.current_char in ALPHA:
                            ...
                            # Emit the integer token first for better parser error messages
                            ...
                            # This allows the parser to see it and provide better error messages
                        continue
